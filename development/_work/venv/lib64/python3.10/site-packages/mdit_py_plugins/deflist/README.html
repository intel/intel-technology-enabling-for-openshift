...
<head>
  ...
  <title>markdown-it-deflist &mdash; Intel® Technology Enabling for OpenShift*</title>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../../docs/supported_platforms.html">Supported Red Hat OpenShift Container Platform (RHOCP) Infrastructure</a></li>
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li class="wy-breadcrumbs-aside">
              <a href="https://github.com/intel/intel-technology-enabling-for-openshift/blob/main/_work/venv/lib64/python3.10/site-packages/mdit_py_plugins/deflist/README.md" class="fa fa-github"> Edit on GitHub</a>
      </li>
  </ul>
  <hr/>
</div>
