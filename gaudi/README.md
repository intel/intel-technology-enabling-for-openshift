...
```
oc apply -f https://raw.githubusercontent.com/intel/intel-technology-enabling-for-openshift/v1.5.0/gaudi/gaudi_firmware_path.yaml
```
...
```
oc apply -f https://raw.githubusercontent.com/intel/intel-technology-enabling-for-openshift/v1.5.0/gaudi/gaudi_nfd_instance_openshift.yaml
```
...
```
oc apply -f https://raw.githubusercontent.com/intel/intel-technology-enabling-for-openshift/v1.5.0/gaudi/gaudi_install_operator.yaml
```
...
```
oc apply -f  https://raw.githubusercontent.com/intel/intel-technology-enabling-for-openshift/v1.5.0/gaudi/gaudi_device_config.yaml
```
